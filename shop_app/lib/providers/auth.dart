...
class Auth with ChangeNotifier {
  ...
  Future<void> _authenticate(
      String email, String password, String urlSegemt) async {
    String url =
        '${AppSettings.googleApiUrl}$urlSegemt?key=${AppSettings.APIKey}';
    try {
  ...
  void _autoLogout() {
    ...
    Timer(Duration(seconds: timeToExpory), logout);
  }
}
